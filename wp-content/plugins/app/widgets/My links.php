    ...
    <div id="add_link">
    <form>
    http://&nbsp;<input type="text" id="add_link_address" value="www." class="link_add_address" size="8" />
    Name:&nbsp;<input type="text" id="add_link_name" value="" class="link_add_name" size="4" />
    <a href="#" id="add_link_button" class="button_link_add" data-role="button">+</a>
    </form>
    </div>
    <div id="link-content">

<table id="link-item" class="link_table">
