...
//("click event applied to #landing-page-data")
...
//("getNs questions running");
      ...
      jQuery.post("http://www.cv-en-anglais.com/php/Show_NS_Questions.php", {user_current : user }, function(data){
       if (data.length>0){
           //("getNs: ok to here");
...
var testArray=new Array("text-10", "text-12", "text-6", "text-20");
//testArray = array('1','2');
//nb = 0; (myarray.length);
//for (0<count())
...
//("this is the value of NS questions " + data);
...
/* GET NON SPECIFIC QUESTION DATA FROM DATABASE */
    ...
    function getUcas(user){
      ...
      jQuery.post("http://www.cv-en-anglais.com/php/Show_Ucas_Questions.php", {user_current : user }, function(data){
       if (data.length>0){
          // ("get UCAS: ok to here");
         //$("#search_results").html(data);
         jQuery("#ucas").empty();
...
/* GET ENGLISH QUESTIONS-LINKS */
    ...
    function getEnglish(user){
      ...
      jQuery.post("http://www.cv-en-anglais.com/php/Show_English_Questions.php", {user_current : user }, function(data){
       if (data.length>0){
           //("get UCAS: ok to here");
         //$("#search_results").html(data);
...
/* GET ENGLISH QUESTIONS-LINKS */
    ...
    function getBeforeLeaving(user){
      ...
      jQuery.post("http://www.cv-en-anglais.com/php/Show_Before_Leaving_Questions.php", {user_current : user }, function(data){
       if (data.length>0){
          // ("get before you leave: ok to here");
         //$("#search_results").html(data);
...
// ------------------------ END UNI-LIST CONTENTS
    ...
    //var id_uni = jQuery(event.target).attr('id');
      ...
      jQuery.post("http://www.cv-en-anglais.com/php/update_tickbox_N_questions.php", {tick_box_val : tick_value, id : id_uni, user1 : user}, function(data){
       if (data.length>0){
