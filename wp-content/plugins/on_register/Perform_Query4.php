...
/* -------------------- Delete all links in NS questions table after user has been deleted ------------ */

public function Delete_Ns_Questions($user)
...
// note, had to use pass uni_nb through as uni_ID as jquery had error
            ...
            //$query = "DELETE from choices WHERE (id = '$this->uniId') AND (user = '$this->user')";
            $query = "DELETE from ns_questions WHERE (user = '$this->user')";
            $result = mysql_query($query)
            or die ("Error: delete uni entry, sorry, an error has occurred, please try again later.");
            //$numrows1 = mysql_num_rows($result)
            //or die ("problem in perform-query - stage 2");
...
// END, DELETE ALL LINKS IN NS QUESTIONS
...
$response = "<form id='specific_questions' style='width:180px';>";
...
// PROB, THIS SHOULD GET THE UNI SPECIFIC ENTRIES

            $query = "SELECT* from s_questions WHERE (user = '$this->user') AND (link_section='finance') ORDER BY quest_nb";
            $result = mysql_query($query)
            or die ("Error: delete s_questions, sorry, an error has occurred, please try again later.");
...
$response = "<form id='non_specific_questions' style='width:180px';>";
...
// SELECT SPECIFIC QUESTIONS
            ...
            $query = "SELECT* from ns_questions WHERE (user = '$this->user') AND (link_section = 'competences') ORDER BY quest_nb";
            $result = mysql_query($query)
            or die ("Error: delete s_questions, sorry, an error has occurred, please try again later.");
...
// SELECT SPECIFIC QUESTIONS
            ...
            $query = "SELECT* from ns_questions WHERE (user = '$this->user') AND (link_section = 'english') ORDER BY quest_nb";
            $result = mysql_query($query)
            or die ("Error: delete s_questions, sorry, an error has occurred, please try again later.");
...
// SELECT SPECIFIC QUESTIONS
            ...
            $query = "SELECT* from ns_questions WHERE (user = '$this->user') AND (link_section = 'before') ORDER BY quest_nb";
            $result = mysql_query($query)
            or die ("Error: delete s_questions, sorry, an error has occurred, please try again later.");
...
$string .= "<tr class='test_link_delete' id='". $obj['id'] ."'><td><div id='". $obj['id'] ."'><a href='". $obj['id'] ."' id='notes-each' target='_blank'>". $obj['name'] ."</a></div></td>";


$string .= "<td><div id='id'><a href='". $obj['id'] ."' class='". $obj['id'] ."' id='delete-button'>x</a></td></tr></div>";
...
$response .= "<form id='notes-item2' style='width:180px';>";

while ($obj = mysql_fetch_array($result))
{
     // BUILD COMBO LIST
//$response .= "<option id=" . $obj['id'] . ">" . $obj['uni_name'] . "</option>";
$response .= "<a href='#' id='back'>< Retour</a><br /><br />";
//$response .= "<option id=" . $obj['id'] . " name=" . $obj['uni_nb'] . ">" . $obj['uni_name'] . "</option>";
$response .= "Name: <input type='textbox' class=" . $obj['id'] . " id='name-update' value=" . $obj['name'] . "><br /><br />";
$response .= "Note: <br /><textarea id='update-content' rows='7' cols='20'>" . $obj['content'] . " </textarea> <br /><br />";
$response .= "<input type='submit' value='Update' id='update-save' class=" . $obj['id'] . "><br />";
...
$string .= "<a href='#' id='link-back'>< Retour</a><br /><br />";
            $string .= "<form id='link'>";
...
if (mysql_num_rows($result) > 0){
  while($row = mysql_fetch_object($result)){
    ...
    $string .= "Name:<br> <input type='textbox' id='link_name' value='".$row->name."'><br><br>";

    $string .= "Address:<br> <input type='textbox' id='link_link' value='".$row->link."'><br><br>";

    $string .= "<input type = 'submit' id='link_submit' class='".$row->id."' value ='update'>";
...
// note, had to use pass uni_nb through as uni_ID as jquery had error
            ...
            //$query = "DELETE from choices WHERE (id = '$this->uniId') AND (user = '$this->user')";
            $query = "UPDATE s_questions SET response = '$this->tickBoxValue' WHERE (id = '$this->questionId') AND (user = '$this->user')";
            $result = mysql_query($query)
            or die ("Error2: update active uni choice. Sorry, an error has occurred, please try again later.");
            //$numrows1 = mysql_num_rows($result)
            //or die ("problem in perform-query - stage 2");
...
if (mysql_num_rows($result) > 0){
  while($row = mysql_fetch_object($result)){
    ...
    $string .= "<tr height='20px' class='test_link_delete' id='".$row->id."'><td height='20px'><div id='".$row->id."'><a href='http://". $row->link ."' id='".$row->id."' target='_blank'>".$row->name."</a></div></td>";
  //  $string .= "<td><a href='.$row->link_address' id='".$row->id."'>".$row->link_name."</a></td>";
   ...
   //$string .= "<td><div id='id'><form name='form-delete' id='form-delete' action='http://wpc4000.amenworld.com/iduk2/joomla-overview/delete.html' method='post'><input type='hidden' name='id2' id='id2' value='".$row->id."'></form></td></div>";

     $string .= "<td height='20px'><div id='delete_link'><a href='#' class='".$row->id."' id='delete_link'>x</a></td></div>";


   // PRINTS OUT UPDATE BUTTON

   $string .="<td height='20px'><div id='id-update'><a href='#' id='update_link' class='".$row->id."'>Update</a></div></td></tr>";
...
//LIMIT 0 , 30
// PERFORM QUERY: UPDATES SESSION TABLE
//Delete from customer_info where customer_id=â€™1â€™;
...
$response = "<select id='uni-list2' style='width:180px';>";
...
$ns["0"]["question_nb"] = "0";
$ns["0"]["response"] = "no";
$ns["0"]["link"] = "http://www.cv-en-anglais.com/comment-ca-marche.html";
$ns["0"]["link_name"] = "Comment ça marche ?";
$ns["0"]["link_section"] = "start";

$ns["1"]["user"] = $this->user1;
$ns["1"]["question"] = "Owner";
$ns["1"]["question_nb"] = "1";
$ns["1"]["response"] = "no";
$ns["1"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv.html";
$ns["1"]["link_name"] = "Les elements d\'un bon CV";
$ns["1"]["link_section"] = "start";

$ns["2"]["user"] = $this->user1;
$ns["2"]["question"] = "Owner";
$ns["2"]["question_nb"] = "3";
$ns["2"]["response"] = "no";
$ns["2"]["link"] = "http://www.cv-en-anglais.com/type-de-cv.html";
$ns["2"]["link_name"] = "Type de CV";
$ns["2"]["link_section"] = "structure";
...
$ns["3"]["question_nb"] = "2";
$ns["3"]["response"] = "no";
$ns["3"]["link"] = "http://www.cv-en-anglais.com/structure-de-votre-cv/quelle-structure.html";
$ns["3"]["link_name"] = "Quelle structure";
$ns["3"]["link_section"] = "structure";

$ns["4"]["user"] = $this->user1;
$ns["4"]["question"] = "Owner";
$ns["4"]["question_nb"] = "1";
$ns["4"]["response"] = "no";
$ns["4"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/analyser-vos-points-forts.html";
$ns["4"]["link_name"] = "Vos points forts";
$ns["4"]["link_section"] = "contenu";

$ns["5"]["user"] = $this->user1;
$ns["5"]["question"] = "Owner";
$ns["5"]["question_nb"] = "2";
$ns["5"]["response"] = "no";
$ns["5"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/coordonnees-personelles.html";
$ns["5"]["link_name"] = "coordonnées personelles";
$ns["5"]["link_section"] = "contenu";

$ns["6"]["user"] = $this->user1;
$ns["6"]["question"] = "Owner";
$ns["6"]["question_nb"] = "3";
$ns["6"]["response"] = "no";
$ns["6"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/section-profile.html";
$ns["6"]["link_name"] = "Profile section";
$ns["6"]["link_section"] = "contenu";

$ns["7"]["user"] = $this->user1;
$ns["7"]["question"] = "Owner";
$ns["7"]["question_nb"] = "4";
$ns["7"]["response"] = "no";
$ns["7"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/section-profile.html";
$ns["7"]["link_name"] = "test";
$ns["7"]["link_section"] = "contenu";

/*$ns["7"]["user"] = $this->user1;
$ns["7"]["question"] = "Owner";
$ns["7"]["question_nb"] = "4";
$ns["7"]["response"] = "no";
$ns["7"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/section-career-aim.html";
$ns["7"]["link_name"] = "Career aim section";
$ns["7"]["link_section"] = "contenu";*/

/* $ns["8"]["user"] = $this->user1;
$ns["8"]["question"] = "Owner";
$ns["8"]["question_nb"] = "5";
$ns["8"]["response"] = "no";
$ns["8"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/experience-professionnelle.html";
$ns["8"]["link_name"] = "Expérience professionnelle";
$ns["8"]["link_section"] = "contenu";

$ns["9"]["user"] = $this->user1;
$ns["9"]["question"] = "Owner";
$ns["9"]["question_nb"] = "6";
$ns["9"]["response"] = "no";
$ns["9"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/vos-diplomes.html";
$ns["9"]["link_name"] = "Vos diplômes";
$ns["9"]["link_section"] = "contenu";

$ns["10"]["user"] = $this->user1;
$ns["10"]["question"] = "Owner";
$ns["10"]["question_nb"] = "7";
$ns["10"]["response"] = "no";
$ns["10"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/vos-competences.html";
$ns["10"]["link_name"] = "Vos competencés";
$ns["10"]["link_section"] = "contenu";

$ns["11"]["user"] = $this->user1;
$ns["11"]["question"] = "Owner";
$ns["11"]["question_nb"] = "8";
$ns["11"]["response"] = "no";
$ns["11"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/centres-dinterets.html";
$ns["11"]["link_name"] = "Vos centres d\'intérêts";
$ns["11"]["link_section"] = "contenu";


$ns["12"]["user"] = $this->user1;
$ns["12"]["question"] = "Owner";
$ns["12"]["question_nb"] = "9";
$ns["12"]["response"] = "no";
$ns["12"]["link"] = "http://www.cv-en-anglais.com/contenu-du-cv/references.html";
$ns["12"]["link_name"] = "Vos références";
$ns["12"]["link_section"] = "contenu";

$ns["13"]["user"] = $this->user1;
$ns["13"]["question"] = "Owner";
$ns["13"]["question_nb"] = "10";
$ns["13"]["response"] = "no";
$ns["13"]["link"] = "http://www.cv-en-anglais.com/techniques-avancees.html";
$ns["13"]["link_name"] = "Techniques avancés";
$ns["13"]["link_section"] = "advanced";

$ns["14"]["user"] = $this->user1;
$ns["14"]["question"] = "Owner";
$ns["14"]["question_nb"] = "11";
$ns["14"]["response"] = "no";
$ns["14"]["link"] = "http://www.cv-en-anglais.com/techniques-avancees/presentation-avancee-sous-word.html";
$ns["14"]["link_name"] = "Présentation avancée WORD";
$ns["14"]["link_section"] = "advanced";

$ns["15"]["user"] = $this->user1;
$ns["15"]["question"] = "Owner";
$ns["15"]["question_nb"] = "12";
$ns["15"]["response"] = "no";
$ns["15"]["link"] = "http://www.cv-en-anglais.com/techniques-avancees/cv-siteweb.html";
$ns["15"]["link_name"] = "CV sur site web";
$ns["15"]["link_section"] = "advanced";

$ns["16"]["user"] = $this->user1;
$ns["16"]["question"] = "Owner";
$ns["16"]["question_nb"] = "13";
$ns["16"]["response"] = "no";
$ns["16"]["link"] = "http://www.cv-en-anglais.com/techniques-avancees/linkedin.html";
$ns["16"]["link_name"] = "LinkedIn";
$ns["16"]["link_section"] = "advanced";

$ns["17"]["user"] = $this->user1;
$ns["17"]["question"] = "Owner";
$ns["17"]["question_nb"] = "14";
$ns["17"]["response"] = "no";
$ns["17"]["link"] = "http://www.cv-en-anglais.com/techniques-avancees/viadeo.html";
$ns["17"]["link_name"] = "Viadeo";
$ns["17"]["link_section"] = "advanced";*/
