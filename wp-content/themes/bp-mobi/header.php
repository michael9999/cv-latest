...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/jq/support-form-trial.js"></script>
	...
	<body <?php body_class() ?> id="bp-default">
		...
		<div class="header">
			...
			<div id="logo" align="center">
				 <a href="<?php bloginfo('home'); ?>" rel="external" id="logo-michael"><img src="<?php bloginfo('stylesheet_directory'); ?>/logo.png" alt="<?php bp_site_name() ?>" /></a>
			</div>
		</div>
