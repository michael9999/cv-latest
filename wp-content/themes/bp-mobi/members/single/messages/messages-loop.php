...
-->
				<?php if ( 'sentbox' != bp_current_action() ) : ?>
					<div width="30%" class="thread-from">
				...
				<div width="50%" class="thread-info">
					<div><a href="<?php bp_message_thread_view_link() ?>" title="<?php _e( "View Message", "buddypress" ); ?>"><?php bp_message_thread_subject() ?></a></div>
					<div class="thread-excerpt"><?php bp_message_thread_excerpt() ?></div>
				</div>

				<?php do_action( 'bp_messages_inbox_list_item' ) ?>

				<div width="13%" class="thread-options">
