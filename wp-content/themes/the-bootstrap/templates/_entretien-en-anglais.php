...
/** _help_center.php
 *
 * Template Name: Entretien d'anglais
 *
		...
		<div class="content-help row-fluid">
			...
			<div class="content-right-new span9 white2">
				...
				// ADD CONTENT HERE 
					...
					echo "<div id='title-serv'><h1 class='entry-title-updated'>Entretien en anglais</h1></div>";
...
<p>
<h2 class="qa-list-question">Qu'est-c'est ?</h2></p>
...
<?php echo 
do_shortcode('[contact-form-7 id="359" title="Paypal form"]'); ?>
