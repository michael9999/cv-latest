...
$Go = new Show_English_Questions();

$Go->Show_English_Questions_Now($_POST["user_current"]);
...
function Show_English_Questions_Now ($user){
...
$go_query4 = $connection2->Get_English_Questions($this->user);
