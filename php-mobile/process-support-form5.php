...
<div class='fLt'>
<input class='textfield required missing' id='support_customer_type' type='hidden' title='Veuillez entrer un nom d'utilisateur.' tabindex='1' size='20' maxlength='50' value='user' test='0' available='0'>
<div class='bodyTextSmall'>
</div>
</div>
</div>
