...
/** _help_center.php
 *
 * Template Name: Correction de CV
 *
		...
		<div class="content-help row-fluid">
			...
			<div class="content-right-new span9 white2">
				...
				// ADD CONTENT HERE 
					...
					echo "<div id='title-serv'><h1 class='entry-title-updated'>Correction de CV</h1></div>";
...
<?php echo 
do_shortcode('[contact-form-7 id="327" title="Paypal form"]'); ?>
