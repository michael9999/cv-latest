...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<!-- try to add extra CSS for responsive capability -->

	
<!--<link rel="stylesheet" type="text/css" href="<?php //echo get_template_directory_uri() . "/css/flexible.css"; ?>"> -->	

<?php
$plugins_url = plugins_url();
?>

<!-- wp accordion plugin CSS -->


<link rel="stylesheet" type="text/css" href="<?php echo $plugins_url . "/wp-accordion/css/uniform.default.css"; ?>">
<link rel="stylesheet" type="text/css" href="<?php echo $plugins_url . "/wp-accordion/css/help.css"; ?>">



<!-- END wp accordion plugin CSS -->

<link rel="stylesheet" type="text/css" media="only screen and (min-width: 220px) and (max-width: 759px)"
href="<?php echo get_template_directory_uri() . "/css/320-759.css"; ?>">

<!-- <link rel="stylesheet" type="text/css" media="only screen and (min-width: 760px) and (max-width: 1201px)"
href="<?php // echo get_template_directory_uri() . "/css/760-1200.css"; ?>">

<link rel="stylesheet" type="text/css" media="only screen and (min-width: 1202px) and (max-width: 1400px)"
href="<?php // echo get_template_directory_uri() . "/css/1200-up.css"; ?>"> -->
