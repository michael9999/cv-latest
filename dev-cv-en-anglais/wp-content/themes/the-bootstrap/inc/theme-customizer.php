...
function the_bootstrap_customize_register( $wp_customize ) {
	...
	//	header colors
	$wp_customize->add_setting( 'header_color1_start' , array(
	    'default'     => '#f5f5f5',
	    'transport'   => 'refresh',
	) );
	
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color_1', array(
		'label'        => __( 'Header Color 1 start', 'the-bootstrap' ),
		'section'    => 'colors',
		'settings'   => 'header_color1_start',
	) ) );

	$wp_customize->add_setting( 'header_color1_end' , array(
	    'default'     => '#f1f1f1',
	    'transport'   => 'refresh',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color_2', array(
		'label'        => __( 'Header Color 1 end', 'the-bootstrap' ),
		'section'    => 'colors',
		'settings'   => 'header_color1_end',
	) ) );
}
