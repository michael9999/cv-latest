...
<html>
	<head profile="http://gmpg.org/xfn/11">
		...
		<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/jq/support-form.js"></script>
	...
	<body <?php body_class() ?> id="bp-default">
		...
		<div class="header">
			<!-- <div id="backBtn">
				<a rel="external" href="javascript:history.go(-1)" data-icon="back" data-role="button" data-theme="b" ><!--<img src="<?php// bloginfo('stylesheet_directory'); ?>/back.png" alt="Back" /> </a>
			</div>-->
