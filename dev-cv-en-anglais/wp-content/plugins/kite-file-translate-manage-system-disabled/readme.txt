...
Download and upload the plugin to your plugins folder. You can activate it to test the ktrs it provides. You will want to edit and use the plugin to learn or as a base, it is not designed to be a plugin for functional use.
