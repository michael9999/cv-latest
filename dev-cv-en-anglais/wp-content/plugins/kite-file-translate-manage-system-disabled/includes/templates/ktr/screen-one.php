	...
	<div id="content">
		<div class="padder">
			...
			<div id="item-body">
				...
				<p><?php printf( __( 'Send %s a <a href="%s" title="Send high-five!">high-five!</a>', 'bp-ktr' ), bp_get_displayed_user_fullname(), wp_nonce_url( bp_displayed_user_domain() . bp_current_component() . '/view-orders/send-h5/', 'bp_example_send_high_five' ) ) ?></p>
