...
//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $test_structure . "</a><br />";

$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a style='text-decoration:" . $line_through . "' class=" . $obj['id'] . " href=" . $obj['link'] . " id='structure-inner'>" . $test_structure . "</a><br />";
...
// check if tickbox is checked, if yes add strike through
...
$start_french = utf8_encode($obj['link_name']);

$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a class=" . $obj['id'] . " style='text-decoration:" . $line_through . "' href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $start_french . "</a><br />";
// $response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id='structure-inner'>" . $test_structure . "</a><br />";
// $response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a style='text-decoration:" . $line_through . "' class=" . $obj['id'] . " href=" . $obj['link'] . " id='structure-inner'>" . $test_structure . "</a><br />";
...
$from = "michaelsmuts@gmail.com";
$headers = "From:" . $from;
mail($to,$subject,$message,$headers);*/
//echo "Mail Sent.";	
	
/*	$response = "<form id='non_specific_questions' style='width:180px';><h1>This some data</h1></form>";
...
//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $obj['link_name'] . "</a><br />";
$test_french;
$test_french = utf8_encode($obj['link_name']);
//$test_french_decode = utf8_decode($obj['link_name']);
//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $test_french . "</a><br />";
$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a class=" . $obj['id'] . " style='text-decoration:" . $line_through . "' href=" . $obj['link'] . " id='contenu-inner'>" . $test_french . "</a><br />";
...
//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $obj['link_name'] . "</a><br />";
$test_advanced = utf8_encode($obj['link_name']);

//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $test_advanced . "</a><br />";
$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a class=" . $obj['id'] . " style='text-decoration:" . $line_through . "' href=" . $obj['link'] . " id='advanced-inner'>" . $test_advanced . "</a><br />";
//$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><a style='text-decoration:" . $line_through . "' class=" . $obj['id'] . " href=" . $obj['link'] . " id='structure-inner'>" . $test_structure . "</a><br />";
