...
$Go = new Show_S_Questions();

$Go->Show_S_Questions_Now($_POST["user_current"]);
...
function Show_S_Questions_Now ($user){
...
$go_query4 = $connection2->Get_S_Questions($this->user);
