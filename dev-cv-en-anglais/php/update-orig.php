...
$deleteGo->updateEntryNow($_POST["user_current"],$_POST['id'], $_POST["name"]);
...
function updateEntryNow ($user, $uniId, $uniName){
...
$go_query4 = $connection2->Update_Uni_Entry($this->user, $this->uniId, $this->uniName);
