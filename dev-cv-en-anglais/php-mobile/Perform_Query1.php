...
$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><label for=". $obj['id'] . " " . $obj['response'] ."><a href=" . $obj['link'] . " id=" . $obj['link_section'] . ">" . $obj['link_name'] . "</a></label>";
...
// SELECT SPECIFIC QUESTIONS
            ...
            $query = "SELECT* from ns_questions WHERE (user = '$this->user') AND (link_section = 'ucas') ORDER BY quest_nb";
            $result = mysql_query($query)
            or die ("Error: delete s_questions, sorry, an error has occurred, please try again later.");
