...
$response .= "<input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><label for=". $obj['id'] . " height=" . $obj['response'] . " " . $obj['response'] .">". $obj['link_name'] . "</label>";
$response .="<a href=" . $obj['link'] . " data-role='button' class='checkBoxLink'><span class='checkBoxLinkVisit'>Visit &nbsp; : &nbsp;</span><span>" . $obj['link_name'] . "</span></a>";
...
//$response .= "<div class='test222' id=" . $obj['id'] . " for=". $obj['response'] ."><input type='checkbox' id=" . $obj['id'] . " " . $obj['response'] . "><label class='ui-btn ui-btn-icon-left ui-btn-corner-all ui-btn-up-c ui-checkbox-off' for=". $obj['id'] . " checked=" . $obj['response'] . ">". $obj['link_name'] . "</label>";
...
$response .= "<div class='test222' id=" . $obj['id'] . " for=". $obj['response'] ."><input type='checkbox' class='testnew' id=" . $obj['id'] . " " . $obj['response'] . "><label class='ui-btn ui-btn-icon-left ui-btn-corner-all ui-btn-up-c ui-checkbox-off' for=". $obj['id'] . " height=" . $obj['response'] . ">". $obj['link_name'] . "</label>";
...
$string .= "<td width='15%'><div id='id' style='". $obj['id'] ."'><a data-role='button' href='". $obj['id'] ."' class='". $obj['id'] ."' id='delete-button' style='". $obj['id'] ."'>x</a></td></tr></div>";
