...
if (mysql_num_rows($result) > 0){
  while($row = mysql_fetch_object($result)){
    ...
    $string = "<tr height='20px' class='test_link_delete' id='".$row->id."'><td  width='45%'><div id='".$row->id."'><a data-role='button' href='http://". $row->link ."' id='".$row->id."' target='_blank'>".$row->link_name."</a></div></td>";
